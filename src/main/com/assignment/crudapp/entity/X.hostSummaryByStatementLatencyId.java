...
public class X.hostSummaryByStatementLatencyId  implements java.io.Serializable {
    ...
    public X.hostSummaryByStatementLatencyId(String host, BigInteger total, BigInteger totalLatency, Long maxLatency, BigInteger lockLatency, BigInteger rowsSent, BigInteger rowsExamined, BigInteger rowsAffected, BigInteger fullScans) {
       this.host = host;
       this.total = total;
