...
public class X.userSummaryByStatementLatencyId  implements java.io.Serializable {
    ...
    public X.userSummaryByStatementLatencyId(String user, BigInteger total, BigInteger totalLatency, BigInteger maxLatency, BigInteger lockLatency, BigInteger rowsSent, BigInteger rowsExamined, BigInteger rowsAffected, BigInteger fullScans) {
       this.user = user;
       this.total = total;
